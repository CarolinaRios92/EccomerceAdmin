...
export default function Nav({show}){
    ...
    return (
        <aside className={(show ? "left-0" : "-left-full") +" top-0 text-gray-500 p-4 pr-4 fixed w-full bg-bgGray h-full md:static md:w-auto transition-all"}>
            ...
            <nav className="flex flex-col gap-2">
                ...
                <Link href={"/"} className={pathname === "/" ? activeLink : inactiveLink}>
                    <svg className={pathname === "/" ? activeIcon : inactiveIcon} aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link href={"/products"} className={pathname.includes("/products") ? activeLink : inactiveLink}>
                    <svg className={pathname.includes("/products") ? activeIcon : inactiveIcon} aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link href={"/categories"} className={pathname.includes("/categories") ? activeLink : inactiveLink}>
                    <svg className={pathname.includes("/categories") ? activeIcon : inactiveIcon} aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link href={"/orders"} className={pathname.includes("/orders") ? activeLink : inactiveLink}>
                    <svg className={pathname.includes("/orders") ? activeIcon : inactiveIcon} aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link href={"/settings"} className={pathname.includes("/settings") ? activeLink : inactiveLink}>
                    <svg className={pathname.includes("/settings") ? activeIcon : inactiveIcon} aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
